...
def cnpj_data_to_df(df_cnpj):
    ...
    for cnpj in df_cnpj['cnpj']:
        ...
        data_set = data_set.append(new_row, ignore_index=True).filter(data_set.atividade_principal_codigo == "6190601")
...
dados_final.to_excel(r"C:\Users\002763\Downloads\Bases de Dados\base_provedores_cnae.xlsx", sheet_name='df')  
